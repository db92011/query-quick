/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3e235ace6b07c0442a84f8abcc51ccf3)
...
declare namespace Cloudflare {
	...
	interface Env {
		FILES: R2Bucket;
		DB: D1Database;
		WISHLIST_INDEX: VectorizeIndex;
		AGENT_DISCOVERY_QUEUE: Queue;
		AGENT_VERIFICATION_QUEUE: Queue;
		WISHLIST_EXTRACTION_QUEUE: Queue;
		GENRE_NORMALIZATION_QUEUE: Queue;
		RANKING_REFRESH_QUEUE: Queue;
		OPEN_STATUS_REFRESH_QUEUE: Queue;
		NOTIFICATION_CHECK_QUEUE: Queue;
